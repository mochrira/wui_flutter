        ...
        children: <Widget>[
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(_localizations.formatMonthYear(_currentMonth), style: WuiTypography.defaultTextStyle.copyWith(
          ...
          child: Row(
            children: [
              Expanded(
                child: WuiButton(
                  style: WuiButtonDefault.small,
                  child: const Text("Hari Ini"),
                  onPressed: () {
                    setState(() {
                      DateTime today = DateTime.now();
                      _handleDateSelected(today);
                      _showMonth(DateTime(today.year, today.month));
                      // _pageController.jumpToPage(DateUtils.monthDelta(widget.firstDate, ));
                    });
                  }
                )
              ),
