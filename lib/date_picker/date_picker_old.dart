...
///    [WuiDatePicker] and provides an optional compact view where the
...
class WuiDatePicker extends StatefulWidget {
  ...
  /// change the [key] to create a new instance of the [WuiDatePicker], and
      ...
      child: Padding(
        ...
        child: Row(
          children: <Widget>[
            ...
            SizedBox(width: (widget.mode == DatePickerMode.day) ? _monthNavButtonsWidth : 12)
          ],
        ),
      ),
    );
...
/// [WuiDatePicker], or [showDatePicker] which create full date pickers.
///
/// See also:
///
///  * [WuiDatePicker], which provides a Material Design date picker
///    interface.
///
